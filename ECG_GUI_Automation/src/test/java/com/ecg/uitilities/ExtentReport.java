...
public class ExtentReport implements ITestListener {
    ...
    public void onStart(ITestContext testContext) {
        ...
        sparkReporter.config().setDocumentTitle("ECG GUI Automation Reports");
        sparkReporter.config().setReportName("ECG Test Report");
        sparkReporter.config().setTheme(Theme.DARK);

        extentReports = new ExtentReports();
        extentReports.attachReporter(sparkReporter);
        extentReports.setSystemInfo("Applcation name", "ECG");
        ...
        extentReports.setSystemInfo("Report created by", "Sanjiv");
    }
    ...
    public void onTestFailure(ITestResult result) {
       ...
       // extentTest.log(Status.FAIL, "Test Failed");
        ...
        System.out.println("Screensoht taken path:  "+screenshotpath);
